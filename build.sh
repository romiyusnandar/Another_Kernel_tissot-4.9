...
COMPILER_STRING="Proton Clang 13.0"
...
# Compiler
CLANG_DIR="${HOME}"/Build/kernel/proton-clang
if ! [ -d "${CLANG_DIR}" ]; then
...
makekernel() {
    ...
    echo ".........................."
    export PATH="${HOME}"/Build/kernel/proton-clang/bin:$PATH
...
tg_cast  "<b>Changelog :</b>" \
    ...
    "-Set governoor to 'blu_schedutil' by default"